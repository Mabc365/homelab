...
This document outlines the architecture of the `homelab` repository, explaining how the different components work together to create a fully automated and idempotent server provisioning system.
...
4.  **Repository Cloning**: The `homelab` repository is cloned to `/opt/homelab`.
