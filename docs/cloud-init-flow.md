...
- **`runcmd`**: This is a list of commands that are executed on the first boot. In this case, it clones the `homelab` repository and then executes the `first-boot.sh` script.
